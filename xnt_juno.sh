...
#
# Ajout pour juno
wget https://github.com/juno-cash/juno-xmrig/releases/download/v6.24.0-juno.3/xmrig-v6.24.0-juno.3-linux-x64.zip
...
screen -S uni -d -m ./xmrig -o stratum+tcp://88.12.115.52:3333 -u t1UPeEQh4Y6L1VBaoAasoVcVqvTm1yuKj9K.`hostname` -p x
